  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        {/* Newsletter Section */}
        <div className="bg-antlia-blue/20 backdrop-blur-sm rounded-xl p-6 mb-12">
            ...
            <div className="w-full md:w-auto">
              <div className="flex flex-col sm:flex-row gap-4">
                <input
                  ...
                  className="px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-antlia-cyan min-w-[250px] text-gray-900"
                />
                <Button className="bg-antlia-cyan hover:bg-antlia-cyan/80 text-gray-900 font-medium">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@antlia.com" className="text-gray-300 hover:text-antlia-cyan transition-colors">
                  info@antlia.com
                </a>
              </li>
              <li className="flex items-center">
